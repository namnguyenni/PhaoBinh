...
namespace Cannon_Project.PDFView
{
    public partial class MainForm : Form
    {
        ...
        {
            pdfViewer1.Document?.Dispose();
            pdfViewer1.Document = OpenDocument(str);
            renderToBitmapsToolStripMenuItem.Enabled = true;
            pagecount.Text = "" + pdfViewer1.Document.PageCount;
            // enable lại thành phần
            toolStripButton1.Enabled = true;
            toolStripButton2.Enabled = true;
            toolStripButton3.Enabled = true;
            toolStripButton4.Enabled = true;
            _fitBest.Enabled = true;
            _fitHeight.Enabled = true;
            _fitWidth.Enabled = true;
        ...
        private void renderToBitmapsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Không có tệp tin nào đang mở!");
                return;
            }
        ...
        public void AblePdf()
        {
            pdfViewer1.Enabled = !pdfViewer1.Enabled;
        }
