...
namespace WindowsApplication1
{
    ...
    {                
        ...
        {            
            ReadFile rf = new ReadFile(Form1.GetAssetsPath() + "Motherboard_ASRock_A330ION.eye");
        ...
        public static void Locomotive(Model model)
        {
...
#if NURBS
            Region r2 = Region.CreateEllipse(0, 19, 8, 19);
#else
            ...
            model.Entities.Add(u9, "Default", Color.IndianRed);
        ...
        public static void Bunny(Model model)
        {
            ...
            ReadFile readFile = new ReadFile(Form1.GetAssetsPath() + "Bunny.eye");
            readFile.DoWork();
        ...
        public static void Pocket(Model model)
        {
            ...
            model.Entities.Add(outerContour, "Default", Color.OrangeRed);
            ...
            model.Entities.Add(innerContour, "Default", Color.OrangeRed);
            ...
            for (int i = 1; i < stepCount; i++)
            {
                foreach (Entity crv in passes)
                {
                    ...
                    model.Entities.Add(en, "Default", Color.DarkBlue);
                }
            }
        }
        ...
        public static void Primitives(Model model)
        {
            ...
            model.Grid.Max.X = 125;
            model.Grid.Max.Y = 175;
            ...
            model.Entities.Add(lp, "Default", Draw.Color);
            offsetX += deltaOffset;
            ...
            mesh = reg.SweepAsMesh(composite, 0.25);
        ...
        {
            Form1.SetBackgroundStyleAndColor(model);
            ...
            model.Entities.Add(pe, "Default", Color.Magenta);
        ...
        {
            Form1.SetDisplayMode(model, displayType.Shaded);
            ...
            model.Entities.Add(m, "Default", Color.Salmon);
        }
